...
def test_5_convert_file_to_data(sample):
    raw_input = convert_file_to_data('day_5/tests/sample.txt')
    assert raw_input == sample


def test_5_create_coordinate_tuple_from_raw():
    raw_input = '0,9 -> 5,9'
...
def test_5_get_coordinates_from_range():
    c1 = Coordinate(1, 1)
    c2 = Coordinate(1, 3)
...
def test_5_get_coordinates_from_range_2():
    c1 = Coordinate(9, 7)
    c2 = Coordinate(7, 7)
    points = get_coordinates_from_range(c1, c2)
    assert points == [
...
def test_5_get_coordinates_from_range_3():
    c1 = Coordinate(0, 4)
    c2 = Coordinate(0, 1)
    points = get_coordinates_from_range(c1, c2)
    assert points == [
...
def test_5_convert_raw_input_to_acceptable_points(sample, acceptable_points):
    assert convert_raw_input_to_acceptable_points(sample) == acceptable_points


def test_5_get_count_of_overlapping_points():
    assert (
...
def test_5_get_count_of_overlapping_points_sample(acceptable_points):
    assert get_count_of_overlapping_points(acceptable_points) == 5
